...
(function gb53_utils(){
	...
	gbDefine('gb53_utils', function setVar(nm, val){ 
		  switch (nm){ case '$': $ = val; break; 	case 'moment': moment = val; break;
		  case 'sprintf': sprintf = val; break;		case 'expect': expect = val; break;
		  case 'Log': Log = val; break;	 
		  default: alert('gb53_utils setVar failed for '+nm); } } );
	...
	var expect	= gbImport( { as: 'expect', from: 'expect' } );		// import expect from expect;  // for verify()
